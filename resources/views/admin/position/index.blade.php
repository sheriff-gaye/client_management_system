...
<div class="px-3  my-6 flex justify-end">
    <a href="{{route('position.create')}}" class="w-fit justify-around px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-lg active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple">
        Add Position
                ...
                <tr class="text-gray-700 dark:text-gray-400">
                    <td class="px-4 py-3">
                        <div class="flex items-center text-sm">
                            <div>
                                <p class="font-semibold">{{$position->position_name}}</p>
                            </div>
                        </div>
                    </td>
                    ...
                    <div class="flex items-center space-x-4 text-sm">
                            <a href="{{route('position.edit',$position->id)}}" class="flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-purple-600 rounded-lg dark:text-gray-400 focus:outline-none focus:shadow-outline-gray" aria-label="Edit">
