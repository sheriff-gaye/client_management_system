...
<div class="px-3  my-8 flex justify-between">
    ...
    <a href="{{route('crm.task.create')}}" class="w-fit  px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-lg active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple">
        Add Task
            ...
            <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                ...
                <tr class="text-gray-700 dark:text-gray-400">
                    <td class="px-4 py-3 text-sm hover:underline ">
                      <a href="{{route('crm.task.show',$task->id)}}">  {{ucfirst($task->title)}}</a>
                    </td>
                    ...
                    <td class="px-4 py-3">
                        ...
                        <div class="flex items-center space-x-4 text-sm">
                            <a href="{{route('crm.task.edit',$task->id)}}" class="flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-purple-600 rounded-lg  focus:outline-none focus:shadow-outline-gray" aria-label="Edit">
