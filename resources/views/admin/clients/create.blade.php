    ...
    <form action="{{route('crm.client.store')}}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mt-2">
            <label class="block text-sm">
                ...
                <input class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input  @error('email') border-red-800 @enderror" placeholder="example@gmail.com" name="email" value="{{old('email')}}" />
                @error('email')
                <p class="text-red-700 text-xs">{{ $message }}</p>
                @enderror
            </label>
        ...
        <div class="mt-2">
            <label class="block text-sm">
                ...
                <input class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input  @error('phone') border-red-800 @enderror" placeholder="+233456**4676" name="phone" value="{{old('phone')}}" />
                @error('phone')
                <p class="text-red-700 text-xs">{{ $message }}</p>
                @enderror
            </label>
